...
const SideBar = ({isMenuOpen, setIsMenuOpen}) => {
  ...
  // add function to delete the chat
  ...
  return (
    <div className={`flex flex-col h-screen min-w-72 p-5 dark:bg-gradient-to-b from-[#242124]/30 to-[#000000]/30
     border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500 max-md:absolute
      ...
      {/* Recent Chats */}
      {chats.length > 0 && (
        <p className="mt-2 mb-1 text-sm ">Recent Chats</p>
      )}
     ...
     className="flex items-center gap-2 p-3 mt-1 mb-1 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer hover:scale-103 transition-all">
      ...
      {/* Now ading close icon to close the sidebar in mobile view  */}
